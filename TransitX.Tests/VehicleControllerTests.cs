...
namespace TransitX.Tests
{
    ...
    {
        private Mock<IRepository<Vehicle>> _mockRepository;
        ...
        public void Setup()
        {
            ...
            _controller = new VehicleController(_mockRepository.Object);
        }
        ...
        public async Task TestGetById_ReturnsVehicle_WhenExists()
        {
            ...
            _mockRepository.Setup(repo => repo.GetById("123")).ReturnsAsync(testVehicle);
        ...
        {
            _mockRepository.Setup(repo => repo.GetById("123")).ReturnsAsync((Vehicle)null);
        ...
        public async Task TestCreate_ReturnsCreatedResponse_OnSuccess()
        {
            ...
            _mockRepository.Setup(repo => repo.Insert(newVehicle)).Returns(Task.CompletedTask);
        ...
        public async Task TestUpdate_ReturnsNoContent_WhenUpdatedSuccessfully()
        {
            ...
            _mockRepository.Setup(repo => repo.Update("123", updatedVehicle)).ReturnsAsync(true);
        ...
        {
            _mockRepository.Setup(repo => repo.Update("123", It.IsAny<Vehicle>())).ReturnsAsync(false);
        ...
        {
            _mockRepository.Setup(repo => repo.Delete("123")).ReturnsAsync(false);
